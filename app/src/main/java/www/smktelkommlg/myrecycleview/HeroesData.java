...
public class HeroesData {
    public static String[] [] data = new String[] []{
            {"Ahmad Dahlan", "Salah seorang ulama dan khatib" +
                    ...
                    "yang juga menjabat penghulu Kesultanan Ngayogyakarta Hadiningrat" +
                    "pada masa itu. KH. Ahmad Dahlan telah mempelopori kebangkitan" +
                    "ummat Islam untuk menyadari nasibnya sebagai bangsa terjajah" +
                    "yang masih harus belajar dan berbuat.",
                    "https://upload.wikimedia.org/wikipedia/commons/8/87/Ahmad_Dahlan.jpg"},

            {"Ahmad Yani", "Jenderal TNI Anumerta Ahmad Yani" +
                    "(juga dieja Achmad Yani; lahir di Purwejo, Jawa Tengah, 19" +
                    "Juni 1922 - menninggal di Lubang Buaya, Jakarta, 1 Oktober 1965" +
                    "pada umur 43 tahun) adalah komandan Tentara Nasional Indonesia" +
                    "Angkatan Darat, dan dibunuh oleh anggota Gerakan 30 September" +
            ...
            {"Gatot Soebroto", "Jenderal TNI (Purn.) Gatot " +
                    ...
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Col_Gatot_Subroto%2C_Kenang-Kenangan_Pada_Panglima_Besar_Letnan_Djenderal_Soedirman%2C_p27.jpg/330px-Col_Gatot_Subroto%2C_Kenang-Kenangan_Pada_Panglima_Besar_Letnan_Djenderal_Soedirman%2C_p27.jpg"},

            {"Ki Hadjar Dewantara", "Raden Mas Soewardi " +
            ...
            {"Mohammad Hatta", "Dr.(HC) Drs. H. Mohammad Hatta " +
                    "(lahir dengan nama Mohammad Athar, dikenal sebagai Bung Hatta; " +
                    "lahir di Fort de Kock (sekarang Bukittinggi, Sumatera Barat), " +
                    "Hindia Belanda, 12 Agustus 1902 – meninggal di Jakarta, 14 Maret " +
                    "1980 pada umur 77 tahun) adalah tokoh pejuang, negarawan, " +
                    "ekonom, dan juga Wakil Presiden Indonesia yang pertama. Ia " +
                    "bersama Soekarno memainkan peranan penting untuk memerdekakan " +
                    "bangsa Indonesia dari penjajahan Belanda sekaligus " +
                    "memproklamirkannya pada 17 Agustus 1945. Ia juga pernah menjabat " +
                    "sebagai Perdana Menteri dalam Kabinet Hatta I, Hatta II, dan " +
                    "RIS. Ia mundur dari jabatan wakil presiden pada tahun 1956, " +
            ...
            {"Soedirman", "Jenderal Besar Raden Soedirman (EYD: " +
                    ...
                    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYiuhncnU3HivtNIk_DNNpgXmYgKkVhTE6Sw&usqp=CAU"},

            {"Soekarno", "Dr.(H.C.) Ir. H. Soekarno (ER, EYD: " +
                    ...
                    "1945. Soekarno adalah yang pertama kali mencetuskan konsep " +
                    "mengenai Pancasila sebagai dasar negara Indonesia dan ia sendiri " +
                    "yang menamainya.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Presiden_Sukarno.jpg/330px-Presiden_Sukarno.jpg"},

            {"Soepomo", "Prof. Mr. Dr. Soepomo (Ejaan " +
                    "Soewandi: Supomo; lahir di Sukoharjo, Jawa Tengah, 22 Januari " +
                    "1903 – meninggal di Jakarta, 12 September 1958 pada umur 55 " +
                    "tahun) adalah seorang pahlawan nasional Indonesia. Soepomo " +
            ...
            {"Tan Malaka", "Tan Malaka atau Ibrahim gelar " +
                    "Datuk Sutan Malaka (lahir di Nagari Pandam Gadang, Suliki, Lima " +
                    "Puluh Kota, Sumatera Barat, 2 Juni 1897 – meninggal di Desa " +
                    "Selopanggung, Kediri, Jawa Timur, 21 Februari 1949 pada umur 51" +
                    " tahun) adalah seorang pembela kemerdekaan Indonesia, tokoh " +
                    "Partai Komunis Indonesia, juga pendiri Partai Murba, dan " +
